...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
  ...
  public static boolean test1() {
    ...
    try {
      ...
      test.rotate(test.findNodeWithData(10), test.findNodeWithData(30));

      if (!test.toLevelOrderString().equals("[ 10, 30 ]")) {
        return false;
      }
    }
  ...
  /**
   * Tests rotate on a complicated model of a BST and makes sure that the correct changes occurred
   * 
   * @return Returns true if test passes, false if it didn't
   */
  public static boolean test2() {
    try {
      ...
      tree.rotate(tree.findNodeWithData(35), tree.findNodeWithData(40));
      String toCheck = "[ 30, 10, 35, 7, 15, 32, 40, 50 ]";
      if (!tree.toLevelOrderString().equals(toCheck)) {
        return false;
      }
   ...
   * 
   * @return Returns true if correct exception is caught, false if not caught
   */
  public static boolean test3() {
    ...
    try {
      ...
      test.rotate(test.findNodeWithData(3), test.findNodeWithData(6));
